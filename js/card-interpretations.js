...
const cardInterpretations = {
    "THE FOOL": {
        en: {
            quote: "Open your heart to new things — today is full of possibilities",
        ...
        ja: {
            quote: "新しいことを受け入れて、今日は可能性に満ちている",
        ...
        ko: {
            quote: "새로운 것을 받아들이세요 — 오늘은 가능성으로 가득합니다",
    ...
    "THE MAGICIAN": {
        ...
        ja: {
            quote: "必要なものはすべて揃っている、あとは行動するだけ",
        ...
        ko: {
            quote: "이미 필요한 모든 것을 가지고 있어요 — 행동으로 옮기세요",
    ...
    "THE HIGH PRIESTESS": {
        ...
        ko: {
            quote: "직감에 귀를 기울이세요 — 답은 당신 안에 있습니다",
        ...
        fr: { quote: "Écoutez votre intuition — la réponse se trouve en vous", interpretation: "Aujourd'hui, vous recevrez des informations ou des documents importants — un e-mail, une lettre ou une notification confidentielle. Votre travail sera axé sur la gestion de documents, la vérification de données ou des tâches exigeant une grande minutie. Par ailleurs, vous devrez peut-être jouer le rôle du bon auditeur aujourd'hui. Quelqu'un viendra vous demander conseil, et vous serez peut-être la seule personne capable de lui donner les orientations dont il a besoin. S'il s'agit d'une affaire personnelle, c'est comme si vous étiez assis(e) au plus profond de son cœur." }
    },
    "THE EMPRESS": {
        en: {
            quote: "Take good care of yourself — abundance is on its way",
        ...
        ko: {
            quote: "자신을 잘 돌보세요 — 풍요가 다가오고 있습니다",
    ...
    "THE EMPEROR": {
        ...
        ja: {
            quote: "慎重に計画し、自信を持って状況をコントロールしよう",
        ...
        ko: {
            quote: "신중하게 계획하고 자신감 있게 상황을 통제하세요",
    ...
    "THE HIEROPHANT": {
        ...
        ko: {
            quote: "경험 많은 사람에게서 배우고 검증된 방법을 따르세요",
    ...
    "THE LOVERS": {
        ...
        ko: {
            quote: "선택의 날 — 흔들리지 않는 마음으로 결정하세요",
        ...
        fr: { quote: "Un jour de choix — décidez avec un cœur résolu", interpretation: "Aujourd'hui, un nouveau membre pourrait rejoindre votre équipe, ou votre entreprise pourrait organiser une activité de cohésion. Les réunions se dérouleront sans accroc — tout le monde sera sur la même longueur d'onde et trouvera facilement un terrain d'entente. Les accords conclus ne seront peut-être pas formalisés par un contrat, mais chacun les respectera de bonne grâce. Si c'est un jour de congé, vous pourriez visiter un centre commercial récemment ouvert ou assister à un événement joliment décoré. Vous pourriez même croiser une célébrité, un idol ou quelqu'un que vous admirez en secret." }
    },
    "THE CHARIOT": {
        en: {
            quote: "Move forward with confidence — victory is within reach",
        ...
        ko: {
            quote: "자신감을 가지고 전진하세요 — 승리가 눈앞에 있습니다",
    ...
    "THE HERMIT": {
        ...
        ja: {
            quote: "一歩引いて、振り返りの時間を取り答えを見つけよう",
        ...
        ko: {
            quote: "한 발 물러서서 되돌아보고 답을 찾는 시간을 가지세요",
        ...
        fr: { quote: "Prenez du recul — accordez-vous du temps pour réfléchir et trouver des réponses", interpretation: "Vous rencontrerez quelqu'un de compétent, capable et profondément spécialisé dans un domaine précis. Sa minutie pourrait ralentir l'avancement du travail. Si vos styles de travail sont très différents, vous pourriez facilement vous sentir agacé(e). Si vous êtes un homme, vous pourrez vous concentrer exceptionnellement bien sur votre travail aujourd'hui et rechercher les connaissances ou informations supplémentaires dont vous avez besoin.\n\nOu si c'est un jour de congé, cela pourrait signifier que vous avez une séance photo prévue avec votre photographe habituel." }
    },
    "WHEEL OF FORTUNE": {
        en: {
            quote: "Life's rhythm is shifting — get ready for new opportunities",
        ...
        ja: {
            quote: "人生のリズムが変わりつつある、新しいチャンスに備えよう",
        ...
        ko: {
            quote: "삶의 흐름이 바뀌고 있어요 — 새로운 기회를 준비하세요",
    ...
    "JUSTICE": {
        ...
        ko: {
            quote: "올바른 일을 하세요 — 결과는 공정하게 돌아옵니다",
        ...
        fr: { quote: "Faites ce qui est juste — le karma vous récompensera équitablement", interpretation: "Vous savez très bien ce qui est juste et ce qui ne l'est pas — que ce soit au travail ou dans vos relations — mais vous n'êtes peut-être pas encore prêt(e) à en parler. Au travail, vous corrigez discrètement la structure et le contenu avant de les représenter au décideur. S'il y a une remise de travail ou une réunion aujourd'hui, votre projet pourrait ne pas être approuvé et vous devrez peut-être presque tout refaire. En ce qui concerne les relations, vous êtes mécontent(e) de l'autre personne mais choisissez de vous taire au lieu d'en discuter, ce qui crée une atmosphère tendue. Ou c'est peut-être l'autre personne qui vous traite de cette façon." }
    },
    "THE HANGED MAN": {
        en: {
            quote: "Pause for a moment, look from a new angle — the answer will appear",
        ...
        ja: {
            quote: "少し立ち止まって、新しい角度から見てみよう、答えが見えてくる",
        ...
        ko: {
            quote: "잠시 멈추고 새로운 시각으로 바라보세요 — 답이 보일 거예요",
        ...
        fr: { quote: "Faites une pause, regardez sous un nouvel angle — la réponse apparaîtra", interpretation: "Vous n'avez pas envie d'aller travailler parce que vous vous sentez patraque depuis hier soir. Mais si vous n'avez pas bu, c'est peut-être simplement un manque de motivation au travail ces derniers temps. Cela peut venir de votre propre état d'esprit ou d'un environnement professionnel peu favorable. Si c'est un jour de repos, vous risquez de décider de rester chez vous sans quitter votre chambre de la journée. Si vous sortez, c'est probablement à l'hôpital ou au temple que vous vous rendrez." }
    },
    "DEATH": {
        en: {
            quote: "Let go of the old to make way for something better",
        ...
        ko: {
            quote: "오래된 것을 놓아주고 더 나은 변화를 위한 길을 열어주세요",
    ...
    "TEMPERANCE": {
        ...
        ko: {
            quote: "천천히 하세요, 서두르지 마세요 — 균형이 핵심입니다",
    ...
    "THE DEVIL": {
        ...
        ko: {
            quote: "유혹을 조심하세요 — 욕망이 삶을 지배하게 두지 마세요",
    ...
    "THE TOWER": {
        ...
        ja: {
            quote: "突然の変化に備えよう、それはより良い方向へ導いてくれる",
        ...
        ko: {
            quote: "갑작스러운 변화에 대비하세요 — 더 나은 것으로 이어질 거예요",
        ...
        fr: { quote: "Préparez-vous à un changement soudain — il mènera à quelque chose de meilleur", interpretation: "Si votre esprit est embrumé et que vous manquez d'idées depuis un moment, essayez d'aller courir ou de faire du sport -- cela pourrait vous aider à débloquer quelque chose. Quant au travail en suspens depuis longtemps, vous pourrez enfin le boucler aujourd'hui, même si le résultat n'est pas aussi parfait que vous l'espériez. Si vous êtes en plein projet, un ordre soudain d'arrêt ou de changement de plan pourrait tomber. Pour ceux qui ont des rendez-vous, attention aux urgences qui pourraient entraîner des annulations. Essayez de garder votre calme, car aujourd'hui les accrochages verbaux avec votre entourage sont faciles." }
    },
    "THE STAR": {
        en: {
            quote: "Keep the faith — good things are about to happen",
        ...
        ko: {
            quote: "희망을 가지세요 — 좋은 일이 곧 일어날 거예요",
    ...
    "THE MOON": {
        ...
        ja: {
            quote: "見えるもの全てを信じないで、隠れているものは徐々に明らかになる",
        ...
        ko: {
            quote: "보이는 것을 다 믿지 마세요 — 숨겨진 것이 서서히 드러날 거예요",
    ...
    "THE SUN": {
        ...
        ja: {
            quote: "今日は特別に輝いている、良いエネルギーがあなたを包んでいる",
        ...
        ko: {
            quote: "오늘은 특별히 밝은 날 — 좋은 에너지가 가득합니다",
    ...
    "JUDGEMENT": {
        ...
        ko: {
            quote: "자신을 돌아보고 새로운 장을 시작할 때입니다",
    ...
    "THE WORLD": {
        ...
        ko: {
            quote: "완벽하게 이루어졌어요 — 다음 목적지로 나아갈 준비가 되었습니다",
    ...
    "ACE OF WANDS": {
        ...
        ja: {
            quote: "新しい始まり、エネルギーとインスピレーションに満ちている",
    ...
    "THREE OF WANDS": {
        ...
        ko: {
            quote: "시야를 넓히세요 — 먼 곳에서 기회가 다가오고 있어요",
    ...
    "FOUR OF WANDS": {
        ...
        ko: {
            quote: "성공을 축하하세요 — 오늘은 행복하게 쉬기 좋은 날이에요",
    ...
    "SEVEN OF WANDS": {
        ...
        ko: {
            quote: "자신의 입장을 지키세요 — 쉽게 물러서지 마세요",
    ...
    "EIGHT OF WANDS": {
        ...
        ja: {
            quote: "すべてが急速に動いている、良い知らせがやってくる",
        ...
        ko: {
            quote: "모든 것이 빠르게 움직이고 있어요 — 좋은 소식이 오고 있습니다",
    ...
    "NINE OF WANDS": {
        ...
        ko: {
            quote: "지치더라도 포기하지 마세요 — 거의 결승선에 다다랐어요",
    ...
    "TEN OF WANDS": {
        ...
        ja: {
            quote: "背負いすぎている、いくつかの荷物を下ろす時が来た",
        ...
        ko: {
            quote: "너무 많이 짊어지고 있어요 — 일부 짐을 내려놓을 때입니다",
    ...
    "PAGE OF WANDS": {
        ...
        ja: {
            quote: "良い知らせが来る、ワクワクする新しいチャンスと共に",
        ...
        ko: {
            quote: "좋은 소식이 오고 있어요, 설레는 새로운 기회와 함께",
    ...
    "KNIGHT OF WANDS": {
        ...
        ja: {
            quote: "今すぐ行動しよう、待つ必要はない、力は始めることにある",
        ...
        ko: {
            quote: "지금 바로 행동하세요, 기다리지 마세요 — 시작하는 것이 힘입니다",
        ...
        fr: { quote: "Agissez maintenant, n'attendez pas — la force réside dans le premier pas", interpretation: "Vous avez la bougeotte ! Vous pourriez devoir vous déplacer sans prévenir. Même si ce n'est pas un long voyage — juste un aller-retour dans la journée — cela rendra votre journée particulièrement animée. Si vous restez à la maison, quelqu'un pourrait débarquer chez vous sans prévenir. Côté amour, attention à ne pas foncer trop fort ou envoyer des messages si vite que vous prenez l'autre au dépourvu. Essayez de modérer votre ardeur avant que l'autre ne prenne peur et ne s'enfuie." }
    },
    "QUEEN OF WANDS": {
        en: {
            quote: "Be confident — let your charm and talent lead the way",
        ...
        ko: {
            quote: "자신감을 가지세요 — 매력과 능력이 길을 안내할 거예요",
    ...
    "KING OF WANDS": {
        ...
        ko: {
            quote: "비전을 가지고 이끌어가세요 — 과감하게 결단하세요",
    ...
    "ACE OF CUPS": {
        ...
        ja: {
            quote: "新しい幸せが流れ込んでくる、心を開いて受け入れよう",
        ...
        ko: {
            quote: "새로운 행복이 밀려오고 있어요 — 마음을 열고 받아들이세요",
    ...
    "FOUR OF CUPS": {
        ...
        ja: {
            quote: "目の前のチャンスに気づこう、退屈に浸っていないで",
        ...
        ko: {
            quote: "눈앞의 기회를 보세요 — 지루함에 빠져있지 마세요",
    ...
    "FIVE OF CUPS": {
        ...
        ja: {
            quote: "失ったものばかり見ないで、良いことがまだ待っている",
        ...
        ko: {
            quote: "잃은 것만 바라보지 마세요 — 좋은 것들이 아직 기다리고 있어요",
        ...
        fr: { quote: "Ne regardez pas que ce qui est perdu — de bonnes choses vous attendent encore", interpretation: "Aujourd'hui, vous pourriez faire face à une déception. Une idée dont vous étiez fier(e) est rejetée sans ménagement, ou une réunion est programmée sans que vous en soyez informé(e) à l'avance -- quand vous le découvrez, elle est déjà à moitié terminée. Un jour de repos, vous pourriez ne pas sortir du lit avant la fin d'après-midi, descendre et ne trouver personne. Vos proches pourraient oublier un rendez-vous ou une date importante pour vous. Mais cette carte pourrait être une bonne nouvelle pour ceux qui font un régime -- montez sur la balance, les chiffres ont peut-être baissé." }
    },
    "SIX OF CUPS": {
        en: {
            quote: "Good memories from the past give you strength today",
        ...
        fr: { quote: "Les bons souvenirs du passé vous donnent de la force aujourd'hui", interpretation: "Quelqu'un qui n'a pas donné de nouvelles depuis longtemps va reprendre contact, mais ce n'est peut-être pas la personne à laquelle vous pensez. Il pourrait s'agir de quelqu'un d'encore plus ancien -- comme un ancien client disparu depuis longtemps. Au quotidien, si c'est un jour de travail, vous recevrez une aide précieuse de votre entourage et ils suivront vos directives à la lettre. S'il y a une réunion ou une présentation, l'autre partie sera impressionnée par ce que vous présentez. Un jour de repos, quelqu'un pourrait passer chez vous à l'improviste. Et si vous avez un rendez-vous aujourd'hui, l'atmosphère sera propice pour commencer à vous fréquenter. Pour ceux qui ont un partenaire mais ne se sont pas vus depuis un moment, aujourd'hui vous vous retrouverez enfin." }
    },
    "SEVEN OF CUPS": {
        en: {
            quote: "Don't just daydream — choose what's actually achievable",
        ...
        ko: {
            quote: "공상에 빠지지 말고, 실제로 이룰 수 있는 것을 선택하세요",
    ...
    "EIGHT OF CUPS": {
        ...
        ja: {
            quote: "間違ったものから離れる勇気を持とう、もっと良いものを見つけるために",
        ...
        ko: {
            quote: "맞지 않는 것에서 벗어나 더 나은 것을 찾아갈 용기를 가지세요",
    ...
    "NINE OF CUPS": {
        ...
        ko: {
            quote: "소원이 이루어져요 — 오늘 바라던 것이 현실이 됩니다",
    ...
    "TEN OF CUPS": {
        ...
        ko: {
            quote: "진정한 행복은 사랑하고 아끼는 사람들과 함께합니다",
    ...
    "PAGE OF CUPS": {
        ...
        ja: {
            quote: "インスピレーションを受け入れよう、創造性が花開いている",
        ...
        ko: {
            quote: "영감을 받아들이세요 — 창의력이 피어나고 있어요",
    ...
    "KNIGHT OF CUPS": {
        ...
        ja: {
            quote: "夢を追いかけよう、自分を表現することを恐れないで",
        ...
        ko: {
            quote: "꿈을 따라가세요 — 자신을 표현하는 것을 두려워하지 마세요",
    ...
    "KING OF CUPS": {
        ...
        ko: {
            quote: "감정을 잘 다스리세요 — 침착함이 진정한 힘입니다",
    ...
    "ACE OF SWORDS": {
        ...
        ko: {
            quote: "명확함이 찾아왔어요 — 날카롭게 결정을 내리세요",
    ...
    "TWO OF SWORDS": {
        ...
        ko: {
            quote: "결정할 수 없나요? 잠시 생각한 후 선택하세요",
    ...
    "FOUR OF SWORDS": {
        ...
        ja: {
            quote: "休んでエネルギーを回復しよう、明日はもっと良くなる",
        ...
        ko: {
            quote: "쉬면서 에너지를 충전하세요 — 내일은 더 나아질 거예요",
    ...
    "FIVE OF SWORDS": {
        ...
        ko: {
            quote: "모든 싸움에서 이길 필요는 없어요 — 가끔은 물러서는 것이 현명합니다",
    ...
    "SIX OF SWORDS": {
        ...
        ko: {
            quote: "오래된 문제를 넘어, 더 나은 곳으로 나아가세요",
    ...
    "SEVEN OF SWORDS": {
        ...
        ko: {
            quote: "부정직한 사람을 조심하세요 — 정보를 신중하게 확인하세요",
    ...
    "EIGHT OF SWORDS": {
        ...
        ja: {
            quote: "出口は必ずある、目を開けて一歩踏み出す勇気を持とう",
        ...
        ko: {
            quote: "항상 출구는 있어요 — 눈을 뜨고 용기를 내어 나아가세요",
    ...
    "NINE OF SWORDS": {
        ...
        ja: {
            quote: "考えすぎないで、ほとんどの心配事は現実にならない",
        ...
        ko: {
            quote: "너무 많이 생각하지 마세요 — 대부분의 걱정은 현실이 되지 않아요",
    ...
    "TEN OF SWORDS": {
        ...
        ko: {
            quote: "가장 힘든 순간은 지나갔어요 — 이제부터는 나아질 뿐입니다",
    ...
    "PAGE OF SWORDS": {
        ...
        ja: {
            quote: "疑問を持ち、事実を探そう、何でも簡単に信じないで",
        ...
        ko: {
            quote: "질문을 던지고 사실을 찾으세요 — 쉽게 믿지 마세요",
    ...
    "QUEEN OF SWORDS": {
        ...
        ko: {
            quote: "이성으로 판단하세요 — 감정이 앞서지 않도록 하세요",
    ...
    "KING OF SWORDS": {
        ...
        ko: {
            quote: "옳은 것을 굳건히 지키고 공정하게 판단하세요",
    ...
    "THREE OF PENTACLES": {
        ...
        ko: {
            quote: "팀으로 일하세요 — 당신의 능력이 인정받을 거예요",
    ...
    "FIVE OF PENTACLES": {
        ...
        ko: {
            quote: "힘든 시기이지만, 도움은 생각보다 가까이 있어요",
    ...
    "SIX OF PENTACLES": {
        ...
        ko: {
            quote: "다른 사람과 나누세요 — 좋은 것이 당신에게 돌아올 거예요",
    ...
    "SEVEN OF PENTACLES": {
        ...
        ko: {
            quote: "인내하세요 — 결과는 들인 노력만큼 가치 있을 거예요",
    ...
    "NINE OF PENTACLES": {
        ...
        ja: {
            quote: "成果を楽しもう、あなたは良いものを受ける価値がある",
        ...
        ko: {
            quote: "성취를 즐기세요 — 당신은 좋은 것을 받을 자격이 있어요",
    ...
    "TEN OF PENTACLES": {
        ...
        ko: {
            quote: "장기적인 안정 — 다음 세대에 물려줄 수 있는 것을 만들어가세요",
    ...
    "PAGE OF PENTACLES": {
        ...
        ko: {
            quote: "새로운 것을 배우기 시작하세요 — 자신에게 투자하세요",
    ...
    "QUEEN OF PENTACLES": {
        ...
        ko: {
            quote: "집과 재정을 잘 돌보세요 — 주변에 안정을 만들어가세요",
